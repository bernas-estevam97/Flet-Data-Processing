...
def main(page: ft.Page):
    ...
    async def run_script_excel_filtering(e):
        ...
        try:
            command = [
                sys.executable, "-u", "src/legacy_v1/ex_filtering_v1.py", 
    ...
    async def run_script_excel_descriptive_stat(e):
        ...
        try:
            command = [
                sys.executable, "-u", "src/legacy_v1/desc_analysis_v1.py", 
    ...
    async def run_script_excel_descriptive_stat_aio(e):
        ...
        try:
            command = [
                sys.executable, "-u", "src/legacy_v1/des_analysis_aio_v1.py", 
